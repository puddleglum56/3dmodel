...
namespace Valve.VR.InteractionSystem.Sample
{
    public class Planting : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            plantAction.AddOnUpdateListener(OnPlantActionUpdate, hand.handType);
        }
        ...
        private void OnPlantActionUpdate(SteamVR_Action_In actionIn)
        {
            plantState(plantAction.GetState(hand.handType));
        ...
        private void DoCube()
        {
            ...
            cubeRotation = hand.transform.rotation;
            if (plantAction.GetState(hand.handType))
            {
                GameObject cubeing = GameObject.Instantiate<GameObject>(prefabToPlant);
                cubeing.transform.position = cubePosition;
                cubeing.transform.rotation = cubeRotation;
            }

        }

        private bool plantState(bool state)
        {
            return state;
        }
        ...
        private void OnPlantActionChange(SteamVR_Action_In actionIn)
        {
            ...
            {
                plantAction.GetState(hand.handType);
                Plant();
            }
        }
